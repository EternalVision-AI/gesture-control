...
from .gesture_control import action_func
...
class GestureRecognition:
    ...
    def _draw_info_text(self, image, brect, handedness, hand_sign_text,
        ...
        if hand_sign_text != "":
            action_func(hand_sign_text)
            info_text = info_text + ' hand : ' + hand_sign_text
        # print(info_text)
        cv.putText(image, info_text, (brect[0] + 5, brect[1] - 4),
                   cv.FONT_HERSHEY_SIMPLEX, 1.6, (0, 0, 255), 1, cv.LINE_AA)
